    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 text-gray-800">
            ...
            <div className="flex justify-between items-center mb-6">
                <Link href="/destinations" className="flex items-center text-gray-500 hover:text-gray-900 transition font-medium">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                ...
                <div className="lg:col-span-2">
                    ...
                    {/* Overview */}
                    <div className="mb-10">
                        <h2 className="text-2xl font-normal mb-4 text-gray-900">Overview</h2>
                ...
                <div className="lg:col-span-1">
                    <Card className="border border-gray-100 shadow-lg sticky top-8 rounded-xl" shadow="sm">
                        <div className="flex flex-col gap-6 p-5">
                            {/* Price */}
                            <div>
                                <p className="text-gray-500 text-sm mb-1">Starting from</p>
                                <div className="flex items-end gap-1">
                                    <span className="text-4xl font-bold text-[#19A5C3]">${price}</span>
                            ...
                            <Input 
                                ...
                                classnames={{ inputWrapper: "bg-gray-50 border-none shadow-none" }}
                            />
                            ...
                            <div className="flex flex-col gap-3 text-sm text-gray-500 mt-2">
                                <div className="flex items-center gap-3">
                                    <Check className="w-4 h-4 text-green-500" /> Free cancellation up to 7 days
                                </div>
                                <div className="flex items-center gap-3">
                                    <Check className="w-4 h-4 text-green-500" /> Travel insurance included
                                </div>
                                <div className="flex items-center gap-3">
